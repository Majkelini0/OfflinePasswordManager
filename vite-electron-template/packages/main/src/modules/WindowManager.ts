...
class WindowManager implements AppModule {
    ...
    async enable({app}: ModuleContext): Promise<void> {
        await app.whenReady();
        Menu.setApplicationMenu(null); // Hide pernamently the default menu bar
    ...
    async createWindow(): Promise<BrowserWindow> {
        const browserWindow = new BrowserWindow({
            ...
            webPreferences: {
                ...
                webSecurity: true, // default is true
        ...
        // ADDED: Add a Content-Security-Policy header to the response
